...
DISPLAY = pi3d.Display.create(x=10, y=10, frames_per_second=20)
...
while DISPLAY.loop_running():
	...
	sprite = pi3d.ImageSprite(pi3d.Texture(image),shader,w=cam_width,h=cam_height,z=5.0)
	sprite.draw()
	sprite.position(10,10,5.0)
